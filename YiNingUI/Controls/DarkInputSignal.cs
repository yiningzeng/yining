...
{
    public class DarkInputSignal : CheckBox
    {
        #region Field Region
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                var boxRect = new Rectangle(0, (rect.Height / 2) - (size / 2), size + 1, size + 1);
                g.DrawRectangle(p, boxRect);
            }

            using (var b = new SolidBrush(fillColor))
            {
                Rectangle boxRect = new Rectangle(0, (rect.Height / 2) - (size / 2), size + 2, size + 2);
