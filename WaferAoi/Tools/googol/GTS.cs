...
namespace WaferAoi.Tools
{
    public class GSN
    {
        ...
        public struct TPosComparePsoPrm//wells0173
        {
            public UInt32 count;
            public ushort hso;
            public ushort gpo;
        ...
        public struct TPosCompareContinueMode//wells0173
        {
            public short mode;
            public ushort count;
        ...
        [DllImport("gts.dll")]
        public static extern short GTN_SetPosComparePsoPrm(short core, short index, ref TPosComparePsoPrm pPrm);//wells0173
        [DllImport("gts.dll")]
        public static extern short GTN_GetPosComparePsoPrm(short core, short index, out TPosComparePsoPrm pPrm);//wells0173
        [DllImport("gts.dll")]
        public static extern short GTN_SetPosCompareStartLevel(short core, short index, short type, short startLevel);//wells0173
