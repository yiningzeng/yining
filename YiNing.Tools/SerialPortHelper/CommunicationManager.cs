            ...
            switch (CurrentTransmissionType)
            {
                ...
                case TransmissionType.Hex:
                    try
                    {
                        ...
                        DisplayData(MessageType.Outgoing, "success sendMsg:" + ByteToHex(newMsg) + "\n");
                    }
                    catch (FormatException ex)
                    {
                        //display error message
                        DisplayData(MessageType.Error, "error sendMsg:" + ex.Message + "\n");
                    }
                    finally
                    {
        ...
        void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            switch (CurrentTransmissionType)
            {
                ...
                case TransmissionType.Text:
                    ...
                    if (msg.Length > 0)
                        DisplayData(MessageType.Incoming, "recevice:" + msg + "\n");
                    break;
                //user chose binary
                case TransmissionType.Hex:
                    ...
                    //display the data to the user
                    if (bytes > 0)
                        DisplayData(MessageType.Incoming, "recevice:" + ByteToHex(comBuffer) + "\n");
                    break;
                default:
                    //read data waiting in the buffer
                    msg = comPort.ReadExisting().Trim();
